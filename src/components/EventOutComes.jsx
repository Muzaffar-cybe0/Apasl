  ...
  const [data, setData] = useState([
    {
      ...
      about: {
        en: "APASL TASHKENT 2025 will foster collaboration among global experts to present groundbreaking research and innovative therapies, particularly focusing on the elimination of viral hepatitis and advancements in liver transplantation.",
        ru: "APASL ТАШКЕНТ 2025 будет способствовать сотрудничеству мировых экспертов для представления новаторских исследований и инновационных методов терапии, с особым вниманием к ликвидации вирусного гепатита и развитию трансплантации печени.",
        uz: "APASL TOSHKENT 2025 global ekspertlar hamkorligini mustahkamlab, ilg‘or tadqiqotlar va innovatsion terapiyalarni taqdim etadi, ayniqsa virusli gepatitni yo‘q qilish va jigar transplantatsiyasini rivojlantirishga alohida e’tibor qaratadi.",
      },
      image: Icon1,
    },
    {
    ...
    },
    {
      ...
      about: {
        en: "APASL TASHKENT 2025 will facilitate international cooperation, encouraging strategic partnerships between researchers, clinicians, and policymakers to develop actionable frameworks for combating liver diseases worldwide.",
        ru: "APASL ТАШКЕНТ 2025 будет способствовать международному сотрудничеству, поощряя стратегические партнерства между исследователями, клиницистами и политиками для разработки эффективных механизмов борьбы с заболеваниями печени во всем мире.",
        uz: "APASL TOSHKENT 2025 xalqaro hamkorlikni rivojlantirib, jigar kasalliklariga qarshi kurash bo‘yicha amaliy strategik asoslarni ishlab chiqish uchun tadqiqotchilar, klinisyenlar va siyosatchilar o‘rtasida hamkorlikni rag‘batlantiradi.",
      },
      image: Icon3,
      delay: "2",
    },
