...
const resources = {
  en: {
    translation: {
      ...
      ticket3: "BUY TICKET",
      ticket4: "Ticket",
      ticket5: "On-site payment is possible.",
      ticketModal1: "Full Name",
      ticketModal2: "Email Address",
      ticketModal3: "Phone Number",
      ticketModal4: "Proceed to Payment",
  ...
  ru: {
    translation: {
      ...
      ticket4: "Билет",
      ticket5: "Оплата на месте возможна",
      ticketModal1: " Ф.И.О",
      ticketModal2: "Электронная почта",
      ticketModal3: "Телефон",
      ticketModal4: "Перейти к оплате",
